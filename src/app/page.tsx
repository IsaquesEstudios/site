...
import First from "./../img/index/isaques-estudios.jpg";
      ...
      <Section>
        ...
        <div className="grid grid-cols-9 gap-x-12 my-32 mobile:grid-cols-2 mobile:my-[0]">
          <div id="programmingImg" className="col-span-5 opacity-0">
            <Image src={Programing} alt="Identidade visual isaques estúdios" />
          </div>

          <div className="col-span-4 flex flex-col justify-center mobile:mt-10">
            <H2 id="programmingTitle" className="opacity-0">
              Campanhas de Tráfego na Web
            </H2>
            <ListToCall
              id="programmingText1"
